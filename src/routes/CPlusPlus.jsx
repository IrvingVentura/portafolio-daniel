...
const CPlusPlus = () => {
  const projects = [
    { id: 1, name: 'Ciclos del Reloj', url: 'https://github.com/IrvingVentura/metodos-numericos/blob/main/102_ciclosReloj.c', icon: <FiTerminal className="inline-block align-middle"/> },
    { id: 2, name: 'Presidencia', url: 'https://github.com/IrvingVentura/metodos-numericos/blob/main/19_precedencia1.c', icon: <FiTerminal className="inline-block align-middle"/> },
    { id: 3, name: 'Operador Lógico', url: 'https://github.com/IrvingVentura/metodos-numericos/blob/main/22_operadorLogico1.c', icon: <FiTerminal className="inline-block align-middle"/> },
    { id: 4, name: 'Operador Condicional', url: 'https://github.com/IrvingVentura/metodos-numericos/blob/main/37_operadorCondicional1.c', icon: <FiTerminal className="inline-block align-middle"/> },
  ];
